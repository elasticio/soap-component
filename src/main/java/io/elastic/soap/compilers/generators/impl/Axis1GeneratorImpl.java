...
import io.elastic.soap.compilers.generators.impl.wsdl.WSDL2Java;
...
public class Axis1GeneratorImpl implements IJaxbGenerator {

    private static final Logger LOGGER = LoggerFactory.getLogger(Axis1GeneratorImpl.class);
     ...
     * case using {@link Axis1GeneratorImpl} is preferred.
     *
...
//                    "-ep", AppConstants.DEFAULT_PACKAGE + ".ignored"
            ...
            final List<Path> paths = Utils.listGeneratedFiles(AppConstants.GENERATED_RESOURCES_DIR + "/org/tempuri");
            ...
            for (final Path p : paths) {
                ...
                final String[] options = new String[]{"-d", AppConstants.GENERATED_RESOURCES_DIR,
                        "-cp", AppConstants.GENERATED_RESOURCES_DIR + "/org/tempuri",
                        "-proc:none",
                        p.toString()};
